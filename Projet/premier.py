...
def execute():
    ...
    print('Équation : ' + str(a) + 'x + ' + str(b) + ' = 0')
    print('Solution :', x1)
    ...
    if v3 == 1:
        ...
        window3.title('f(x) = ' + str(a) + 'x + ' + str(b))
    ...
    if v4 == 1:
        ...
        window4.title('f(x) = ' + str(a) + 'x + ' + str(b))
    ...
    if v1 == 1:
        ...
        window2.title('f(x) = ' + str(a) + 'x + ' + str(b))
        ...
        title = Label(window2, text="La solution de l'équation f(x)=0 est :", bg="#fcbf49")
    ...
    if v2 == 1:
        ...
        y = a*x+b
        plt.plot(x, y)
        plt.title("Graphique de f(x) = " + str(a) + 'x + ' + str(b))
        plt.xlabel("x")
        plt.ylabel("f(x)")
        plt.grid(True)
        plt.show()
